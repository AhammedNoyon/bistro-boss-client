...
const Register = () => {
  return (
    <div className="bg-loginRegisterBg bg-no-repeat bg-cover py-4">
      <div className=" w-11/12 md:w-5/6 mx-auto flex flex-col lg:flex-row-reverse items-center justify-center my-10 md:my-20 gap-5 md:p-10 shadow-2xl">
